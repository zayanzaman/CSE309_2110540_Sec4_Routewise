        ...
        <section class="selector">            
            <div class="selector-card">                
                <div class="selector-img">
                    <img src="imgs/brt.jpg" alt="Dhaka Bus Rapid Transit">
                </div>
                <div class="selector-content">
                    <h2>Bus Rapid Transit (BRT)</h2>
                    <a href="brt.php"><button>Learn More</button></a>
                </div>
            </div>
            <div class="selector-card">                
                <div class="selector-img">
                    <img src="imgs/mrt.jpg" alt="Dhaka Mass Rapid Transit">
                </div>
                <div class="selector-content">
                    <h2>Mass Rapid Transit (MRT)</h2>
                    <a href="mrt.php"><button>Learn More</button></a>
                </div>
            </div>
        </section>               
    </main>
